                    ...
                    <table class="table table-hover table-sm align-middle mb-0">
                        ...
                        <tbody>
                            @forelse($categories as $category)
                                <tr style="height: 60px;"> <!-- Batasi height baris agar lebih rapat -->
                                    <td class="ps-4 py-2">
                                        <div class="d-flex align-items-center">
                                            @if($category->image)
                                                <img src="{{ Storage::url($category->image) }}" class="rounded me-2" width="40" height="40" style="margin-bottom: 0;">
                                            @else
                                                <div class="bg-light rounded d-flex align-items-center justify-content-center me-2" style="width: 40px; height: 40px; margin-bottom: 0;">
